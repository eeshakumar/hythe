...
if is_local:
  ...
  demo_dir_default = "/home/ekumar/output/experiments/exp_0de9a416-7b06-419c-b6e4-b47df846ee68"
else:
  num_episodes = 50000
  num_scenarios = 1000
  num_demo_scenarios = 5
  ...
  # default dir with demonstrations data
  demo_dir_default = "/mnt/glusterdata/home/ekumar/demonstrations/exp_0de9a416-7b06-419c-b6e4-b47df846ee68"
...
def save_transitions(params, ego_world_states, columns, filename):
    ...
    df.to_pickle(os.path.join(params["Experiment"]["dir"], "demonstrations", filename))
...
def run(args, params, env, exp_exists=False, db=None):
    ...
    if is_train_mixed_experiences:
      ...
      params["Experiment"]["demonstraions_exp"] = demo_dir_default
